...
The goal of this app is to build use Rails built-in session features to
authenticate users making requests to the Rails API. For ease of deployment,
both projects are contained in the same repository. All React code is in the
`/client` directory during development.
